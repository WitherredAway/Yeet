...
class CodeModal(discord.ui.Modal):
    field_1 = discord.ui.TextInput(
        label="Input", style=discord.TextStyle.paragraph, required=False
    )
    field_2 = discord.ui.TextInput(
        label="\u200b", style=discord.TextStyle.paragraph, required=False
    )
    field_3 = discord.ui.TextInput(
        label="\u200b", style=discord.TextStyle.paragraph, required=False
    )
    field_4 = discord.ui.TextInput(
        label="\u200b", style=discord.TextStyle.paragraph, required=False
    )
    field_5 = discord.ui.TextInput(
        label="\u200b", style=discord.TextStyle.paragraph, required=False
    )
