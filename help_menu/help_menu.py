...
class PrettyHelp(HelpCommand):
    ...
    def get_ending_note(self):
        ...
        note = self.ending_note or (
            f"Type {self.context.clean_prefix}{self.context.invoked_with} command for more info on a command.\n"
            f"You can also type {self.context.clean_prefix}{self.context.invoked_with} category for more info on a category."
        )
        return note
